...
#
# Script generated by Vivado on Tue Jul 14 09:12:12 +0300 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clocking_wizard.sh
...
#
# Usage        : clocking_wizard.sh
#                clocking_wizard.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clocking_wizard.sh [-rerun]
#                clocking_wizard.sh [-reset_run]
#                clocking_wizard.sh [-clean]
#                clocking_wizard.sh [-reset_log]
#                clocking_wizard.sh [-help]
#
...
# script info
echo -e "clocking_wizard.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clocking_wizard.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clocking_wizard xil_defaultlib.clocking_wizard xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clocking_wizard -key {Behavioral:sim_1:Functional:clocking_wizard} -tclbatch cmd.tcl -protoinst "protoinst_files/clocking_wizard.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clocking_wizard.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clocking_wizard.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clocking_wizard.sh [-help]\n\
Usage: clocking_wizard.sh [-step]\n\
Usage: clocking_wizard.sh [-lib_map_path]\n\
Usage: clocking_wizard.sh [-rerun]\n\
Usage: clocking_wizard.sh [-reset_run]\n\
Usage: clocking_wizard.sh [-clean]\n\
Usage: clocking_wizard.sh [-reset_log]\n\
Usage: clocking_wizard.sh [-keep_index]\n\
Usage: clocking_wizard.sh [-noclean_files]\n\n\
